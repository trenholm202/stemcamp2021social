        ...
        return (
            <div className="nav-header bg-white shadow-xs border-0">
                <div className="nav-top">
                    <Link to="/"> <img src="assets/images/favicon.png" alt="icon" />STEM Camp Summer 2021 </Link>
                ...
                <img src="assets/images/stem20212.png" alt="icon" /><img src="assets/images/tren1.png" alt="icon" /><img src="assets/images/stem20212.png" alt="icon" />
