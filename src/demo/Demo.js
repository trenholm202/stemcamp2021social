        ...
        return (
            ...
            <div className="header-wrapper demo-style">
                <div className="container max-container">
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-3 col-xs-6"><a href="/" className="logo"><i className="feather-zap text-success display2-size me-3 ms-0"></i><span className="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Socala. </span> </a></div>
                    ...
                    <div className="container max-container">
                        <div className="row">
                            <div className="col-lg-5 col-md-6 col-sm-8">
                                ...
                                <h2 className="title-text mb-5 mt-5"><b>Set up your <span>Social</span> website with But God.</b></h2>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-5 offset-lg-1">
                            <h2 className="title-text2 mb-4 mt-5"><b>Awesome Components Ready Elements and Templates.</b></h2>				<p>Socala powers thousands of apps at some of the smartest companies around the world. Be a part of professional community.</p>
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-5 mt-5 mb-5">
                                        ...
                                        <p>With beautifully designed custom post types to show off your works and collections.Socala powers thousands of apps at some of the smartest companies around the world. Be a part of professional community</p>
